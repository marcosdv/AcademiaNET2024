...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        while (opcao != 9)
        {
            ...
            Console.WriteLine("6 -> Buscar por Categoria");
            Console.WriteLine("7 -> Listar dados do DataSet");
            Console.WriteLine("8 -> Listar dados por Categoria");
            ...
            switch (opcao)
            {
                ...
                case 6: BuscaPorCategoria(); break;
                case 7: noticias.CriarDataSet(); break;
                case 8: noticias.CriarDataSetComCategoria(); break;
                case 9: break;
    ...
    private static void BuscaPorCategoria()
    {
        Console.Write("Filtrar por nome da categoria: ");
        string categoria = Console.ReadLine();

        noticias.BuscarDadosViewPorCategoria(categoria);
    }
