...
namespace Aula04.Repositories
{
    public class CategoriaRepository
    {
        ...
        public IList<NoticiaCategoriaResponse> BuscarNoticiaComCategoria(string filtroCategoria)
        {
            try
            {
                connection.Open();
                ...
                command.Parameters.AddWithValue("@NomeCategoria", filtroCategoria);
                //command.Parameters.AddWithValue("@NomeCategoria", filtroCategoria).Direction = ParameterDirection.Input;
